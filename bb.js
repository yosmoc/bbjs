...
BB.prototype = {
    ...
    _comment: function(n) {
        var comment = ["−","−","−","−","−","攻撃力アップ(使い捨て)","攻撃力アップ",
                      "防御力アップ(使い捨て)","防御力アップ","ＨＰアップ","情報カード",
                      "薬草","ＭＰアップ"];
        return comment[n];
    },
    
    _job: function(n) {
        var job = ["戦士","戦士","戦士","戦士","戦士","戦士","戦士","魔法使い",
                       "魔法使い","魔法使い"];
        return job[n];
    },

    _ability: function(n) {
        var ability = ["−","−","−","攻撃力７／１０","攻撃力１／２","守備力７／１０",
                       "守備力１／２","守備力４／５","ＨＰ７／１０","ＨＰ１／２",
                       "特殊能力無効"];
        return ability[n];
    }
};
